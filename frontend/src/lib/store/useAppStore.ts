...
export const useAppStore = create<AppStore>((set) => ({
  ...
  setWeeklyDraft: (rows, semana) => set({ weeklyDraft: rows, weeklyDraftSemana: semana }),
  clearWeeklyDraft: () => set({ weeklyDraft: null, weeklyDraftSemana: null }),
